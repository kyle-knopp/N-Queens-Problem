...
public class LinkedStack<E> implements Cloneable
{
   ...
   **/ 
   ...
   /**
   * Get the nth item from the stack, without removing from stack
   * @param - none
   * <dt><b>Precondition:</b><dd>
   *   This stack is not empty.
   * <dt><b>Postcondition:</b><dd>
   *   The return value is the nth item of this stack.
   *@param int nth element that you would like to return
   * @exception NoSuchElementException
   *   Indicates that element is not present.
   **/    
